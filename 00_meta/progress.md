...
| # | Category | Description |
| :--- | :--- | :--- |
| 15 | `Docs` | Created [`MOC.md`](https://github.com/jiansuphd/portfolio/blob/main/00_meta/MOC.md) — central index for all `00_meta/` files |
...
| # | Category | Description |
| :--- | :--- | :--- |
| 26 | `Dev` | Phase 1.1 — Mobile hamburger menu implemented in [`index.html`](https://github.com/jiansuphd/portfolio/blob/main/index.html) |
...
| # | Category | Description |
| :--- | :--- | :--- |
| 34 | `Audit` | Explained history to user |
...
| # | Category | Description |
| :--- | :--- | :--- |
| 45 | `Docs` | Phase 1 & 2 guide added to [`Tech Stack.md`](https://github.com/jiansuphd/portfolio/blob/main/00_meta/Tech%20Stack.md) |
